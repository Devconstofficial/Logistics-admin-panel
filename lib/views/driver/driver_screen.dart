...
import 'package:logistics_admin_panel/common_widgets/driver_info_dialog.dart';
            ...
            children: [
              ...
              Obx(
                () => CustomTable(
                  ...
                  val3: 'date',
                  title: 'Driver',
                  onDelete: controller.deleteDriver,
                  statusOptions: controller.statuses,
                  onUpdate: (userId, newStatus) {
                    controller.updateDriverStatus(userId, newStatus);
                  },
                  onViewDetail: (driver) {
                    Get.dialog(
                      DriverInfoDialog(
              ...
              Obx(
                () => Row(
                  ...
                  children: [
                    ...
                    ...List.generate(
                      (controller.filteredDrivers.length /
